...
- 尽量选择开箱即用的工具，减少命令行和复杂配置。
- 明显的广告、会员墙或者体验限制会单独标出来。
- 每个分类把最稳妥的选择放在前面。
...
| 软件 | 适用场景 | 推荐理由 | 成本 / 限制 | 可替代方案 | 官网 |
| --- | --- | --- | --- | --- | --- |
| **PowerToys** | Windows 效率增强 | 微软官方工具集，窗口布局、批量重命名、取色器、键盘映射、文本提取 | 免费开源 | 无 | [官网](https://github.com/microsoft/PowerToys) |
...
| **ScreenToGif** | GIF / 演示录制 | 录教程、录界面反馈特别方便 | 免费 | 无 | [官网](https://www.screentogif.com) |
...
| **Calibre** | 电子书管理 | 本地电子书库管理、格式转换最强 | 免费开源 | 无 | [官网](https://calibre-ebook.com) |
...
| 软件 | 适用场景 | 推荐理由 | 成本 / 限制 | 可替代方案 | 官网 |
| --- | --- | --- | --- | --- | --- |
| **Git** | 版本控制 | 开发基础设施 | 免费开源 | 无 | [官网](https://git-scm.com) |
| **GitHub Desktop** | Git 图形客户端 | 不想用命令行的话，这个最友好 | 免费 | 无 | [官网](https://desktop.github.com) |
| **Windows Terminal** | 终端 | 微软官方终端，标签页和主题都不错 | 免费开源 | 无 | [官网](https://github.com/microsoft/terminal) |
...
| **HandBrake** | 视频转码 | 开源压片/转码老工具，稳 | 免费开源 | 无 | [官网](https://handbrake.fr) |
...
| 软件 | 适用场景 | 推荐理由 | 成本 / 限制 | 可替代方案 | 官网 |
| --- | --- | --- | --- | --- | --- |
| **AIMP** | 本地音乐播放 | 轻快稳定，本地音乐党首选 | 免费 | 无 | [官网](https://www.aimp.ru) |
...
| **DiskGenius** | 分区 / 克隆 / 数据恢复 | 磁盘分区、数据恢复、迁移系统都很实用 | 免费版够用 | 无 | [官网](https://www.diskgenius.cn) |
| **Hasleo Backup Suite** | 备份恢复 | 备份 / 克隆 / 系统恢复一体，好上手 | 免费个人版 | 无 | [官网](https://www.easyuefi.com/backup-software/backup-suite-free.html) |
