...
> 一份面向普通用户的电脑软件推荐清单 —— 开箱即用、不折腾、装完就能干活。
...
- **新电脑先装**：浏览器、压缩、搜索、卸载、截图、下载器、播放器、输入法
- **学生 / 轻办公**：Office、PDF、笔记、思维导图、云同步、邮件、在线协作
- **日常沟通**：微信、QQ、腾讯会议、钉钉、飞书
- **开发者**：VS Code、Git、Docker、DBeaver、Postman
- **创作者**：剪映、DaVinci Resolve、Blender、Krita、GIMP、OBS Studio
- **系统维护**：Rufus、Ventoy、CrystalDiskInfo、DiskGenius、VirtualBox
- **远程协作**：ToDesk、向日葵、坚果云、LocalSend
...
| **搜狗输入法** | 中文输入 | 国内普及度最高的输入法，词库和云联想强 | 免费，有广告可关 | 微信输入法 / 百度输入法 / 微软拼音 | [官网](https://shurufa.sogou.com) |
...
| **PowerToys** | Windows 效率增强 | 微软官方工具集，包含窗口布局、批量重命名、取色器等 | 免费开源 | — | [官网](https://github.com/microsoft/PowerToys) |
| **LocalSend** | 局域网传文件 | 跨平台局域网快传，体验干净，无需账号 | 免费开源 | 微信文件传输 | [官网](https://localsend.org) |
...
| **Docker Desktop** | 容器开发 | 开发者最省心的 Docker 入口 | 个人免费 | — | [官网](https://www.docker.com/products/docker-desktop) |
...
| **DBeaver** | 数据库管理 | 开源通用数据库客户端，够全够稳 | 免费开源 | — | [官网](https://dbeaver.io) |
...
| **OBS Studio** | 录屏 / 直播 | 免费开源，直播和录屏首选 | 初次配置需花点时间 | — | [官网](https://obsproject.com) |
...
| **Internet Download Manager** | 多线程下载 | 老牌下载工具，资源嗅探能力强 | 商业软件 | Motrix | [官网](https://www.internetdownloadmanager.com) |
...
| **HWMonitor** | 温度电压监控 | 看 CPU / GPU / 主板状态很直接 | 免费 | — | [官网](https://www.cpuid.com/softwares/hwmonitor.html) |
| **Hasleo Backup Suite** | 备份恢复 | 备份 / 克隆 / 系统恢复一体，好上手 | 免费个人版 | — | [官网](https://www.easyuefi.com/backup-software/backup-suite-free.html) |
| **VirtualBox** | 虚拟机 | 免费开源，日常测试够用 | 免费 | — | [官网](https://www.virtualbox.org) |
...
| **XMind** | 思维导图 | 做梳理、复盘、提纲特别顺手 | 免费版够用 | — | [官网](https://xmind.app) |
...
- **只想省心装机**：Edge / 7-Zip / Everything / Snipaste / 搜狗输入法 / Ditto / VLC / PowerToys 基本闭眼装。
- **学生 / 轻办公**：WPS Office / PDFgear / 腾讯文档 / 石墨文档 / 坚果云 / 网易邮箱大师。
- **开发者常用**：VS Code + Git + Windows Terminal + Docker + DBeaver + Postman。
- **创作者常用**：剪映专业版（入门）/ DaVinci Resolve（进阶）+ Blender + Krita + OBS Studio + HandBrake。
- **系统维护**：Ventoy / Rufus + CrystalDiskInfo + DiskGenius + VirtualBox。
