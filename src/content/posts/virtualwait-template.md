...
> 想知道哪台机空着、什么时候轮到自己，又不想靠纸条和喊人维持队伍？VirtualWait 就是为这个场景做的。

[VirtualWait-Template](https://github.com/Bad0RANG3/VirtualWait-Template) 是一套面向游戏机台、街机厅等场地的虚拟排队系统。它不只是展示队列的网页，还把排队规则、身份确认、管理员运营和群通知串成了一套可以自己托管的系统。
...
VirtualWait 的设计思路就几条：把排队变成清晰可见的状态，让系统替人做重复劳动，默认安全，单机可跑，模块可拆。
